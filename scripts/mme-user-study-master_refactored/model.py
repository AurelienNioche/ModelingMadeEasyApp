...
class Model:
    ...
    def __init__(self, ax1, ax2,
        ...
        self.cost = torch.zeros(self.n_covars + 1) + 0.05
        # cost[-1] = 0.5
    ...
    def recommend(self, act_in, included_vars):
        ...
        if masked.size != 0:
            ...
            j = [x for x in np.argsort(self.corr_mat[act_in, :]) if mask[x]][-1]
    ...
    def do_one_step(self):
        ...
        if act_in != -1:
            self.recommend(act_in, included_vars)
