"""
Django settings for ModelingMadeEasyApp project.
...
SECRET_KEY = 'django-insecure-kyv)*bncn+=u9_su^7ujrj_5jnmon2vkh5(*zhv8u+lhz3t=)x'
...
ROOT_URLCONF = 'ModelingMadeEasyApp.urls'
...
WSGI_APPLICATION = 'ModelingMadeEasyApp.wsgi.application'
